...
public class LoginService {
    ...
    public static void isViewLoaded(){
        MobileActionManager.waitVisibility(LoginConstants.LOGIN_BUTTON_LOCATOR);
        Assert.assertTrue( MobileActionManager.isVisible(LoginConstants.LOGIN_BUTTON_LOCATOR), LoginConstants.VIEW_NOT_DISPLAYED_MESSAGE);
    }
}
